...
class SeparatedPlanUiIntegrationTest {
    ...
    void planOverviewShowsCollapsiblePhasesCombinedElementsAndUnderstandableMetadata() throws Exception {
        ...
        String html = mockMvc.perform(get("/projects/{projectId}/plan", project.getId())
                ...
                .andExpect(content().string(containsString("<header class=\"pf-plan-section__header\"")))
                .andExpect(content().string(not(containsString("<details class=\"pf-plan-section plan-phase plan-section\""))))
                ...
                .andExpect(content().string(containsString("class=\"pf-dropdown pf-dropdown--left pf-plan-view-dropdown pf-plan-view-switcher\"")))
                .andExpect(content().string(not(containsString("<details class=\"pf-dropdown pf-dropdown--left pf-plan-view-dropdown"))))
