...
import de.melinadanhier.projectflow.generation.client.StubGenerationScenario;
import de.melinadanhier.projectflow.generation.client.StubPreCheckScenario;
...
class StubAiClientTest {
    ...
    private final AiStubProperties properties = new AiStubProperties();
    ...
    void providesAllPreCheckScenariosWithVersionedStructuredResponses() {
        properties.setPreCheckScenario(StubPreCheckScenario.NO_PROBLEMS);
        assertThat(client.preCheck(preCheckRequest()).problems()).isEmpty();

        properties.setPreCheckScenario(StubPreCheckScenario.WARNING);
        assertThat(client.preCheck(preCheckRequest()).problems())
                .extracting("severity").containsExactly(AiPreCheckSeverity.WARNING);

        properties.setPreCheckScenario(StubPreCheckScenario.ERROR);
        assertThat(client.preCheck(preCheckRequest()).problems())
    ...
    void generatesMultiplePhasesTasksAndMilestonesWithDates() {
        properties.setGenerationScenario(StubGenerationScenario.WITH_DATES);
    ...
    void generatesTheSameCentralStructureWithoutAnyDates() {
        properties.setGenerationScenario(StubGenerationScenario.WITHOUT_DATES);
