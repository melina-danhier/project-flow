...
public class GenerationPromptBuilder {
    ...
    public AiPrompt build(AiWizardSnapshot confirmedSnapshot, List<AiPreCheckProblem> ignoredWarnings) {
        return build(new de.melinadanhier.projectflow.generation.dto.request.AiGenerationRequest(
                confirmedSnapshot, ignoredWarnings));
    }

    public AiPrompt build(de.melinadanhier.projectflow.generation.dto.request.AiGenerationRequest request) {
